...
export class PreloadScene extends Phaser.Scene {
  ...
  private generateTextures() {
    ...
    // ── Item box ───────────────────────────────────────────────────────────
    const ib = this.make.graphics({ x: 0, y: 0 }, false);
    ...
    // ── Checkpoint marker ──────────────────────────────────────────────────
    const cp = this.make.graphics({ x: 0, y: 0 }, false);
    ...
    // ── Projectile textures ────────────────────────────────────────────────
    const banana = this.make.graphics({ x: 0, y: 0 }, false);
    ...
    const shell = this.make.graphics({ x: 0, y: 0 }, false);
